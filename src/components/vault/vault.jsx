            ...
            title={
              <React.Fragment>
                <Typography variant={"h5"} className={classes.fees}>
                  There is a 0.01% withdrawal fee on all investment vaults.
                </Typography>
              </React.Fragment>
            }
            arrow
  ...
  renderBasedOn = () => {
    ...
    return (
      <div className={classes.basedOnContainer}>
        ...
        <Typography>
          Growth is based on the company's performance{" "}
          {basedOn === 4 ? "since" : "for the past"}
        </Typography>
        <TextField
          id={"basedOn"}
          name={"basedOn"}
